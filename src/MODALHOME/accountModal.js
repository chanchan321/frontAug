                                                ...
                                                {!showchangepass?
                                                  <>
                                                      ...
                                                      <div className='flex flex-col md:flex-row justify-around'>
                                                            ...
                                                            <div className='mb-2'>
                                                                <div>ContactNumber</div>
                                                                <input type='text' placeholder='example +639123456789' ref={editRef} readOnly={edit} onChange={(e)=> setcontactnumber(e.target.value)} value={contactnumber}  className='w-[300px] max-h-[50px] shadow-inner shadow-gray-500/50 border-[1px] border-gray-200 rounded-md px-2'
                                                                ></input>
                                                    ...
                                                    {!showchangepass? <div onClick={()=>patterrn()} className='self-end rounded-sm bg-green-400 hover:bg-green-500 cursor-pointer px-2 my-4 shadow-sm shadow-black'>change password</div>:
                                                    <>
                                                    ...
                                                    <button onClick={()=>backk()} className='self-end rounded-sm bg-green-400 hover:bg-green-500 cursor-pointer px-4 py-1 my-4 shadow-sm shadow-black'>back</button>
                                                    </div>
                                                    </>}
